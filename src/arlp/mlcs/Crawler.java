...
public class Crawler {
    ...
    public static int removeThreshold  = 100;
...
//                    List<List<Location>> paths = result.count.intValue() > 30 ? graph.findKeyPartialPaths() : graph.findKeyPaths();
...
//                    Main.writeFile(file + "_reslut", strPaths);
    ...
    public static Mlcs.Result bfs(Mlcs mlcs, Graph graph) {
        ...
        Set<Location> locations = RadixSortingbeta2.sort(new HashSet<>(mlcs.nextSortedLocations(start)), 0, 0.5);
